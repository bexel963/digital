...
public class Math클래스1 {
	...
	public static double round(double num, int count) {
		for(int i=1 ; i<=count ; i++) {				// 원래 값에 10의 count 제곱만큼 곱함
			num *= 10;
		}
		// 결과에서 round()
