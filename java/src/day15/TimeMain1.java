...
public class TimeMain1 {
	...
	public static void main(String[] args) {
		...
		Calendar today = Calendar.getInstance();			//갈색 - 매개변수, 지역변수 / 파란색 - 멤버변수 / 굵은글씨 기울어짐 - 상수(static fianl)
		/* get(int field)
			- field값에 따라 년, 월, 일, 주 등의 다양한 정보를 정수로 반환한다.
			- 월(MONTH)의 경우 0~11을 반환
			- 요일 : 일요일(1), 월(2), 화(3), 수(4), 목(5), 금(6), 토(7)		// get()의 리턴값은 int형으로 고정
