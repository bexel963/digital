...
public class 클래스4 {
	...
	public static void main(String[] args) {
		 ...
		 * 8. 객체 멤버변수는 클래스 멤버메소드에서 사용할 수 없다. ( 클래스 멤버 메소드가 객체 멤버 변수보다 먼저 생성 되어서 )
...
class SamsungTv {
	...
	public void printPower() {						
		if(power)									// 가능(객체 멤버변수는 객체 멤버메소드에서만 사용할 수있다.)
	...
	public static void printBrand() {				// 클래스 멤버 메소드
		...
		//System.out.println(power);				// 불가능(객체 멤버변수는 클래스 멤버 메소드에서 사용할 수 없다.)
	}
