...
public class 연산자2 {
	...
	public static void main(String[] args) {
		//증감 연산자 : 최종적으로 변수의 값을 1증가 or 1감소 -> ++, --
		//연산자 위치에 따라서 동작이 약간 다름
		//전위형 : ++변수, --변수	-> 증감를 하고 동작을 한다
		//후위형 : 변수++, 변수--	-> 동작을 하고 증감을 한다
		...
		//10 ^ 12 : 00000110 -> 6
		//~10 :		11110101 -> -11
		//10 << 2 :	00101000 -> 40		왼쪽으로 두칸 밈
		//10 >> 2 : 00000010 -> 2		오른쪽으로 두칸 밈
		...
		//조건선택 연산자 : (조건식) ? A : B;	-> 조건식이 참이면 A를 거짓이면 B를 선택
